...
namespace GestionInfirmerieBO
{
    public class Eleve
    {
        ...
        public string Num_portable { get => Num_portable_eleve; set => Num_portable_eleve = value; }
        public string Num_portable_parent { get => Num_portable_parent_eleve; set => Num_portable_parent_eleve = value; }
